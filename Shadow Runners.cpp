...
bool Level1()
{
    while (moveToMenu == true)
    {
        ...
        pl.setScale(Vector2f(0.2f, 0.10f));
        ...
        while (gameplay.isOpen())
        {
            ...
            float playerright = playerleft + 20.f;
            float playertop = pl.getPosition().y;
            float playerbottom = playertop + 20.f;
            for (int i = 0; i < 17; i++)
            {
                ...
                for (int j = 0; j < 17; j++)
                {
                    ...
                    if (arr[i][j] == 'p')
                    {
                        ...
                        if ((playerright > hurdleleft && playerleft < hurdleright && playertop < hurdlebottom && playerbottom > hurdletop))
                        {
            ...
            for (int i = 0; i < 17; i++) {
                for (int j = 0; j < 29; j++) {
                    if (arr[i][j] == 'w' || arr[i][j] == 'o') {  // Check for walls or obstacles
                        ...
                        // Player positions
                        float playerLeft = player.getPosition().x + 5;
