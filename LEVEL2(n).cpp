...
//void MazeMaking(RenderWindow& window,  Texture& backTex) {
//    for (int i = 0; i < r; i++) {
//        for (int j = 0; j < c; j++) {
//            if (arr[i][j] == 'a') {
...
bool Level2()
{
...

    {
        ...
        RectangleShape test(Vector2f(tilesize, tilesize));
        ...
        /*for (size_t k = 0; k < coinpos.size();k++) {
            Vector2f pos = coinpos[k];
        ...
        for (int i = 0; i < r; i++)
        {
            for (int j = 0; j < c; j++)
            {
                if (collectibles[i][j] != 'c' && collectibles[i][j] != 'a')
                {
                    collectibles[i][j] = 'z';
                }
           ...
           //Checking for screen collision here  
            ...
            for (int i = 0; i < r; i++)
            {
                for (int j = 0; j < c; j++)
                {
                    ...
                    if (arr[i][j] == 'a')
                    {
                        //box.setPosition(tilesize* j, tilesize* i);
                        window.draw(box);
                    }
                }
            }
